...
class AdministrasiWidget extends StatefulWidget {
  const AdministrasiWidget({Key? key}) : super(key: key);

  @override
  _AdministrasiWidgetState createState() => _AdministrasiWidgetState();
}
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown(
                        ...
                        onChanged: (val) =>
                            setState(() => jenisKelaminValue = val),
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(16, 12, 16, 0),
                      child: FlutterFlowDropDown(
                        options: ['Keperluan 1', 'Keperluan 2', 'Keperluan 3'],
                        onChanged: (val) =>
                            setState(() => keperluanValue = val),
                        width: double.infinity,
                        height: 60,
                        textStyle:
